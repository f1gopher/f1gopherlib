...
var sessionHistory = [...]RaceEvent{
	{
		...
		TimeLostInPitlane: time.Duration(19914) * time.Millisecond,
	...
	},
	{
		...
		TimeLostInPitlane: time.Duration(0) * time.Millisecond,
	...
	},
	{
		...
		TimeLostInPitlane: time.Duration(20865) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(20300) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(21290) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2021,
		TimeLostInPitlane: time.Duration(22900) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(22516) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(27315) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(21598) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2021,
		TimeLostInPitlane: time.Duration(16745) * time.Millisecond,
	...
	},
	{
		...
		TimeLostInPitlane: time.Duration(20421) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(18918) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(26303) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(29106) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(21150) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2023,
		TimeLostInPitlane: time.Duration(19564) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(22109) * time.Millisecond,
	...
	},
	{
		...
		TimeLostInPitlane: time.Duration(27800) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2022,
		TimeLostInPitlane: time.Duration(16186) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(17831) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2022,
		TimeLostInPitlane: time.Duration(15164) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2022,
		TimeLostInPitlane: time.Duration(17873) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(22336) * time.Millisecond,
	...
	{
		Country:           "Bahrain",
		RaceTime:          time.Date(2023, 2, 25, 7, 0, 0, 0, time.UTC),
		EventTime:         time.Date(2023, 2, 25, 7, 0, 0, 0, time.UTC),
		Type:              Messages.PreSeasonSession,
		Name:              "Bahrain Test Day 3",
		timezone:          "Asia/Bahrain",
		TrackName:         "Bahrain International Circuit",
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(22336) * time.Millisecond,
		urlName:           "https://livetiming.formula1.com/static/2023/2023-02-23_Bahrain_Test/2023-02-23_Test/",
	},
	{
		Country:           "Bahrain",
		RaceTime:          time.Date(2023, 2, 24, 7, 0, 0, 0, time.UTC),
		EventTime:         time.Date(2023, 2, 24, 7, 0, 0, 0, time.UTC),
		Type:              Messages.PreSeasonSession,
		Name:              "Bahrain Test Day 2",
		timezone:          "Asia/Bahrain",
		TrackName:         "Bahrain International Circuit",
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(22336) * time.Millisecond,
	...
	{
		Country:           "Bahrain",
		RaceTime:          time.Date(2023, 2, 23, 7, 0, 0, 0, time.UTC),
		EventTime:         time.Date(2023, 2, 23, 7, 0, 0, 0, time.UTC),
		Type:              Messages.PreSeasonSession,
		Name:              "Bahrain Test Day 1",
		timezone:          "Asia/Bahrain",
		TrackName:         "Bahrain International Circuit",
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(22336) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(32822) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2020,
		TimeLostInPitlane: time.Duration(20292) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(22119) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2020,
		TimeLostInPitlane: time.Duration(20898) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2020,
		TimeLostInPitlane: time.Duration(21974) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(20206) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2020,
		TimeLostInPitlane: time.Duration(15571) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(17262) * time.Millisecond,
	...
	},
	{
		...
		TrackYearCreated:  2018,
		TimeLostInPitlane: time.Duration(20115) * time.Millisecond,
